...
class AddIfMin(private val socket: ClientSocket, private val labWorkCreatorClient: LabWorkCreatorClient): Command {
    /**
     * Command label
     *
    ...
    override fun getDescription(): String {
        return "Add new element to server collection from console if min less then minElement"
    }
